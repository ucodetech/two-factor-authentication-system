                ...
                <ul class="nav nav-tabs" data-tabs="tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="#" data-toggle="tab">
                      <i class="material-icons fa fa-sign-in fa-lg"></i>
                      Login Advisor
   ...
   $(document).ready(function(){
     ...
     $('#loginBtn').click(function(e){
       ...
       $.ajax({
         ...
         method:'post',
         data:$('#indLoginForm').serialize()+'&action=loginAdvisor',
         beforeSend:function(){
           $('#loginBtn').html('<img src="../gif/tra.gif">Checking...');
         },
         success:function(response){
           if (response==='success') {
               $('#indLoginForm')[0].reset();               $('#indLoginForm')[0].reset();
