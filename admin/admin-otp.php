                ...
                <ul class="nav nav-tabs" data-tabs="tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="#profile" data-toggle="tab">
                      <i class="material-icons fa fa-sign-in fa-lg"></i> Verify Token
          ...
          <div class="card-body">
            <div class="tab-content">
              <div class="tab-pane active">
                <span class="text-info"> Please enter the token sent to your email to processed</span>
                <hr>
...
<?php
 ...
 // verify token
     $('#verifyBtn').click(function(e){
       e.preventDefault();
       $.ajax({
         url:'scripts/otp-process.php',
         method:'post',
         data: $('#verifyTokenform').serialize()+'&action=verifyAdmin',
         beforeSend:function(){
